...
Always provide a summary of results in a clear, readable format. When you receive tool results, respond with the answer instead of stating future intentions.`
    };
  }
