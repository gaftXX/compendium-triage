import { ClaudeTool } from '../services/claudeAIService';
...
export class ToolRegistry {
  ...
  private registerDatabaseTools(): void {
    ...
    this.tools.set('get_office_full_profile', {
      ...
      description: 'Load the complete dataset for a specific office, including workforce, projects, relationships, meditations, and saved workspaces.',
      category: 'database',
      requiresApproval: false,
      destructive: false,
      input_schema: {
