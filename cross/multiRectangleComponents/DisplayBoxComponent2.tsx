...
export interface DisplayBoxComponent2Props {
  startRow: number;
  startCol: number;
  text: string;
  className?: string;
...
export const DisplayBoxComponent2: React.FC<DisplayBoxComponent2Props> = ({
  startRow,
  startCol,
  text,
  className,
  ...
  if (!positionCalculator.isValidPosition(endRow, endCol)) {
    throw new Error(`DisplayBoxComponent2: ${width}x${height} box at [${startRow},${startCol}] extends beyond grid boundaries`);
  }
